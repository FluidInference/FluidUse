...
Sorts Oxford-IIIT Pets test photos into 37 breeds with SigLIP 2 (base, 256 px) on Core ML. The only hint the model
...
- `IMAGE_SORT_COUNT` sets the sample size (default 1,000; the test split has 3,669).
- Orange buckets are cat breeds, blue are dog breeds; a green frame means the gold label agrees.
